...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><img src="../images/prof.png" alt="favicon"><a href="./professionals.php" data-target="main-content">Clients</a></li>
            <li><img src="../images/appointmen1.png" alt="favicon"><a href="./appointment.php" data-target="main-content">Appointments</a></li>
